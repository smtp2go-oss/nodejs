...
class SMTP2GOService {
  constructor(endpoint, requestBody, method) {
    this.endpoint = endpoint;
    this.requestBody = requestBody || /* @__PURE__ */ new Map();
...
class InlineAttachment extends MailAttachment {
  constructor(cid, file) {
    super(file);
    this.filename = cid;
  }
}
class mailService extends SMTP2GOService {
  constructor() {
    super("email/send");
    this.toAddress = [];
    this.ccAddress = [];
  ...
  _addAddressOfType(emailAddress, t) {
  ...
  async buildRequestBody() {
    const requestBody = /* @__PURE__ */ new Map();
    ...
    if (this.attachments.length || this.inlines.length) {
      ...
      ["attachments", "inlines"].forEach((attachmentType) => {
        this[attachmentType].forEach((attachment) => {
...
class webMailService extends mailService {
  constructor() {
    super();
  }
  attach(attachment) {
